...
public class UODWithThreadsProducer extends Thread {
    ...
    public UODWithThreadsDiscover discoverer;
    ...
    public UODWithThreadsProducer(UODWithThreadsPool pool,UODWithThreadsDiscover discoverer,DataFrame data,PartialDataFrame sampleData){
